---
title: 谁能想到，斗地主也能玩出算法
source: https://labuladong.online/zh/algo/practice-in-action/split-array-into-consecutive-subsequences/
author:
  - "[[../../../../author/labuladong]]"
published:
created: 2026-02-17
description: 本文利用贪心思想和哈希表解决 力扣/LeetCode 的 659 题分割数组为连续子序列，同时给出 Java/Python/Go/JavaScript/C++ 代码实现。
tags:
  - clippings
---
...
类似前文 [回溯算法进行集合划分](https://labuladong.online/zh/algo/practice-in-action/partition-to-k-equal-sum-subsets/) ，我们想把 `nums` 的元素划分到若干个子序列中，其实就是下面这个代码逻辑：
