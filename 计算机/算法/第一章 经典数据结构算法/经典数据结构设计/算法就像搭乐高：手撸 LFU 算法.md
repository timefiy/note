...
- [哈希表实现](https://labuladong.online/zh/algo/data-structure-basic/hashtable-chaining/)

上篇文章 [带你手写LRU算法](https://labuladong.online/zh/algo/data-structure/lru-cache/) 写了 LRU 缓存淘汰算法的实现方法，本文来写另一个著名的缓存淘汰算法：LFU 算法。
...
class LFUCache {
    ...
    std::unordered_map<int, std::unordered_set<int>> freqToKeys;
...
![](https://labuladong.online/images/algo/lfu/1.jpg)
...
经过层层拆解，LFU 算法就完成了。更多数据结构设计相关的题目参见 [数据结构设计经典习题](https://labuladong.online/zh/algo/problem-set/ds-design/) 。
