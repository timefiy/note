...
published:
created: 2026-02-17
description: 本文总结了力扣/LeetCode 上单链表题目的所有技巧，包括有序链表的合并、链表的分解、链表成环判定、寻找环起点、链表交点、链表中点、链表倒数第 k 个节点等问题。
tags:
  - clippings
---
...
![](https://labuladong.online/images/lc/uploads/2021/01/04/partition.jpg)
```
...
这里我们就要用到优先级队列这种数据结构，把链表节点放入一个最小堆，就可以每次获得 `k` 个节点中的最小节点。关于优先级队列可以参考 [优先级队列（二叉堆）原理及实现](https://labuladong.online/zh/algo/data-structure-basic/binary-heap-implement/) ，本文不展开。
...
这道题还有一个经典的解法，在 [分治算法核心框架](https://labuladong.online/zh/algo/essential-technique/divide-and-conquer/) 中详细讲解，这里不展开。
...
![](https://labuladong.online/images/lc/uploads/2020/10/03/remove_ex1.jpg)
```
...
![](https://labuladong.online/images/algo/linked-list-two-pointer/7.png)
...
到这里，链表相关的双指针技巧就全部讲完了，这些技巧的更多扩展延伸见 [更多链表双指针经典习题](https://labuladong.online/zh/algo/problem-set/linkedlist-two-pointers/) 。
