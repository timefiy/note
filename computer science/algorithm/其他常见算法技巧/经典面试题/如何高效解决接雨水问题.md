...
![](https://labuladong.online/images/lc/aliyun-lc-upload/uploads/2018/10/22/rainwatertrap.png)
...
![](https://labuladong.online/images/algo/rain-water/0.jpg)
...
![](https://labuladong.online/images/algo/rain-water/1.jpg)

![](https://labuladong.online/images/algo/rain-water/2.jpg)
...
![](https://labuladong.online/images/algo/rain-water/3.jpg)
...
![](https://labuladong.online/images/algo/rain-water/4.jpg)

此时的 `l_max` 是 `left` 指针左边的最高柱子，但是 `r_max` 并不一定是 `left` 指针右边最高的柱子，这真的可以得到正确答案吗？

其实这个问题要这么思考，我们只在乎 `min(l_max, r_max)` 。 **对于上图的情况，我们已经知道 `l_max < r_max` 了，至于这个 `r_max` 是不是右边最大的，不重要。重要的是 `height[i]` 能够装的水只和较低的 `l_max` 之差有关** ：

![](https://labuladong.online/images/algo/rain-water/5.jpg)
...
**11\. 盛最多水的容器** | [力扣](https://leetcode.cn/problems/container-with-most-water/) | [LeetCode](https://leetcode.com/problems/container-with-most-water/)
...
![](https://labuladong.online/images/lc/aliyun-lc-upload/uploads/2018/07/25/question_11.jpg)
...
题目来源： [力扣 11. 盛最多水的容器](https://leetcode.cn/problems/container-with-most-water/) 。
