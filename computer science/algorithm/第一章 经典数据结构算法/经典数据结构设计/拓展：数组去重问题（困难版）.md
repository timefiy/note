...
published:
created: 2026-02-17
description: 本文讲解 力扣/LeetCode 去除重复字母问题的解法，运用单调栈的思路逐步求解，给出 Java/Python/Go/JavaScript/C++ 代码实现。
tags:
  - clippings
---
...
- [单调栈原理及实现](https://labuladong.online/zh/algo/data-structure/monotonic-stack/)

关于去重算法，应该没什么难度，往哈希集合里面塞不就行了么？

最多给你加点限制，问你怎么给有序数组原地去重，这个我们前文 [双指针技巧秒杀七道数组题目](https://labuladong.online/zh/algo/essential-technique/array-two-pointers-summary/) 讲过。
...
其实这里会借鉴前文 [单调栈解题框架](https://labuladong.online/zh/algo/data-structure/monotonic-stack/) 中讲到的「单调栈」的思路，没看过也无妨，等会你就明白了。
