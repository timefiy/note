...
published:
created: 2026-02-06
description: 图结构是多叉树的延伸。本文介绍图结构的基本概念，介绍邻接表和邻接矩阵两种图的实现方式，分析有向图、无向图、有向加权图、无向加权图的联系，并给出 Java/C++/Python/Golang/JavaScript 的代码实现。
tags:
  - clippings
---
前置知识
...
看到这个实现，你有没有很熟悉？它和我们之前说的 [多叉树节点](https://labuladong.online/zh/algo/data-structure-basic/n-ary-tree-traverse-basic/) 几乎完全一样：
