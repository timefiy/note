...
这里介绍一下「森林」这个名词，后面讲到[Union-Find 并查集算法](../../第一章%20经典数据结构算法/经典图算法/Union-Find%20并查集算法.md)时，会用到这个概念。
...
多叉树的层序遍历和 [二叉树的递归层序遍历](二叉树的递归层序遍历.md) 一样，都是用队列来实现，无非就是把二叉树的左右子节点换成了多叉树的所有子节点。所以多叉树的层序遍历也有三种写法，下面一一列举。
