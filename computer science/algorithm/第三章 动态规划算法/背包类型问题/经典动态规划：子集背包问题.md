...
上篇文章 [经典动态规划：0-1 背包问题](https://labuladong.online/zh/algo/dynamic-programming/knapsack1/) 详解了通用的 0-1 背包问题，今天来看看背包问题的思想能够如何运用到其他算法题目。

**读者在阅读本文之前务必读懂前文 [经典动态规划：0-1 背包问题](https://labuladong.online/zh/algo/dynamic-programming/knapsack1/) 中讲的套路，因为本文就是按照背包问题的解题模板来讲解的** 。
...
[经典动态规划：背包问题](https://labuladong.online/zh/algo/dynamic-programming/knapsack1/) 已经详细解释过了，状态就是「背包的容量」和「可选择的物品」，选择就是「装进背包」或者「不装进背包」。
...
所以，我们可以参照 [对动态规划进行降维打击](https://labuladong.online/zh/algo/dynamic-programming/space-optimization/) ，将二维 `dp` 数组压缩为一维，节约空间复杂度：
