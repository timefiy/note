...
tags:
  ...
  - 前缀和
  - 待优化
source: http://leetcode.cn/problems/construct-product-matrix/solutions/3935356/shuang-jie-yi-wei-zhan-kai-hou-qian-hou-a1gin/
---

# 构造乘积矩阵

> [!question] 题目描述
> ![题目截图](assets/2906.构造乘积矩阵/file-20260325223814726.png)
>
...
> **解题思路**：
>
> 1. 对于任意位置，其"除自身外乘积" = (该位置之前所有元素的乘积) × (该位置之后所有元素的乘积)
> 2. 定义前缀乘积数组 pre[k] 表示前 k 个元素的乘积，后缀乘积数组 suf[k] 表示第 k 个元素之后所有元素的乘积
> 3. 模运算性质：$$ (a \times b) \pmod m = ((a \pmod m) \times (b \pmod m)) \pmod m $$
